    ...
    window.RuntimeInterface = class RuntimeInterface {
        constructor(opts) {
            ...
            if (IsWebViewExportType(this._exportType) && this._useWorker) {
                console.warn("[C3 runtime] Worker mode is enabled and supported, but is currently disabled in WebViews. Reverting to DOM mode.");
                this._useWorker =
                    false
            }
        ...
        _GetWorkerURL(url) {
            ...
            else if (url.endsWith("/workermain.js") && this._workerScriptURLs.hasOwnProperty("workermain.js")) ret =
        ...
        async _MaybeGetCordovaScriptURL(url) {
            if (this._exportType === "cordova" && (url.startsWith("file:") || location.protocol === "file:" && this.IsRelativeURL(url))) {
                let filename = url;
    ...
    const HANDLER_CLASS = class RuntimeDOMHandler extends self.DOMHandler {
        constructor(iRuntime) {
            ...
            iRuntime.AddRuntimeComponentMessageHandler("runtime",
                "raster-svg-image", e => this._OnRasterSvgImage(e));
            ...
            iRuntime.AddRuntimeComponentMessageHandler("runtime",
                "go-to-script", e => this._OnPostToDebugger(e));
            ...
            iRuntime.AddRuntimeComponentMessageHandler("runtime",
                "add-stylesheet", e => this._OnAddStylesheet(e));
        ...
        Attach() {
            ...
            window.addEventListener("dblclick",
                e => this._OnMouseEvent("dblclick", e, DISPATCH_RUNTIME_AND_SCRIPT));
    ...
    const HANDLER_CLASS = class BrowserDOMHandler extends self.DOMHandler {
        ...
        _OnRequestFullscreen(e) {
            if (this._exportType === "windows-webview2" || this._exportType === "macos-wkwebview") {
                ...
                else if (navUI === 2) opts["navigationUI"] =
                    "show";
